...
function ThemeToggle() {
  ...
  return createComponent(Select, {
    ...
    itemComponent: (props) => createComponent(Select.Item, {
      ...
      "class": "px-3 py-1.5 text-sm cursor-pointer rounded hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 outline-none data-[highlighted]:bg-slate-100 dark:data-[highlighted]:bg-slate-700",
      get children() {
    ...
    get children() {
      return [createComponent(Select.Trigger, {
        "class": "flex items-center gap-1 px-2 py-1 text-sm rounded border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors",
...
//# sourceMappingURL=app-yb1Vxejn.mjs.map
