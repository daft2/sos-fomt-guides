import { createComponent, isServer, ssr, ssrHydrationKey, escape, ssrAttribute, getRequestEvent, delegateEvents, ssrElement, mergeProps as mergeProps$1, Portal, Dynamic, ssrStyle, ssrStyleProperty } from 'file:///Users/daffa/daffa/sos-fomt/node_modules/.pnpm/solid-js@1.9.11/node_modules/solid-js/web/dist/server.js';
...
var _tmpl$$4 = ["<option", "", ">", "</option>"], _tmpl$2$1 = "<option></option>", _tmpl$3$1 = ["<div", ' style="', '" aria-hidden="true"><input type="text"', ' style="', '"', "", ">", "</div>"];
...
var _tmpl$$3 = ["<svg", ' display="block" viewBox="0 0 30 30" style="transform:scale(1.02)"><g', '><path fill="none" d="M23,27.8c1.1,1.2,3.4,2.2,5,2.2h2H0h2c1.7,0,3.9-1,5-2.2l6.6-7.2c0.7-0.8,2-0.8,2.7,0L23,27.8L23,27.8z"></path><path stroke="none" d="M23,27.8c1.1,1.2,3.4,2.2,5,2.2h2H0h2c1.7,0,3.9-1,5-2.2l6.6-7.2c0.7-0.8,2-0.8,2.7,0L23,27.8L23,27.8z"></path></g></svg>'];
...
function PopperArrow(props) {
  ...
  return createComponent(Polymorphic, mergeProps$1({
    ...
    get children() {
      return ssr(_tmpl$$3, ssrHydrationKey(), ssrAttribute("transform", escape(rotate(), true), false));
    }
  }));
}
...
var _tmpl$$2 = ["<span", ' class="text-xs opacity-60">\u25BE</span>'];
const THEME_OPTIONS = [{
  value: "light",
  label: "Light"
}, {
...
function ThemeToggle() {
  ...
  return createComponent(Select, {
    ...
    itemComponent: (props) => createComponent(Select.Item, {
      get item() {
        return props.item;
      },
      ...
      get children() {
        return createComponent(Select.ItemLabel, {
          get children() {
            var _a;
            return (_a = THEME_OPTIONS.find((o) => o.value === props.item.rawValue)) == null ? void 0 : _a.label;
          }
        });
      }
    }),
      ...
      return [createComponent(Select.Trigger, {
        ...
        get children() {
          return [createComponent(Select.Value, {
            children: (state) => {
              var _a, _b;
              return (_b = (_a = THEME_OPTIONS.find((o) => o.value === state.selectedOption())) == null ? void 0 : _a.label) != null ? _b : "Theme";
            }
        ...
        get children() {
          return createComponent(Select.Content, {
            "class": "z-50 min-w-[8rem] rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-md p-1",
            get children() {
...
var _tmpl$$1 = ["<button", ' type="button" aria-label="Toggle language" class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm font-medium text-slate-700 transition-colors hover:border-sky-400 hover:text-sky-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:border-sky-500 dark:hover:text-sky-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500"><span aria-hidden="true">', "</span><!--$-->", "<!--/--></button>"];
function LanguageToggle() {
  const {
    lang,
    setLang
  } = useI18n();
  return ssr(_tmpl$$1, ssrHydrationKey(), lang() === "en" ? "\u{1F1EE}\u{1F1E9}" : "\u{1F1EC}\u{1F1E7}", lang() === "en" ? "ID" : "EN");
}
...
var _tmpl$ = ["<svg", ' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5" aria-hidden="true"><path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z"></path></svg>'], _tmpl$2 = ["<nav", ' class="bg-green-800 dark:bg-slate-900 transition-colors duration-300 shadow-md"><div class="container mx-auto px-4"><div class="flex items-center h-14 gap-2"><!--$-->', '<!--/--><ul class="hidden md:flex items-center gap-0.5 ml-4">', '</ul><div class="ml-auto flex items-center gap-2"><!--$-->', "<!--/--><!--$-->", "<!--/--><!--$-->", '<!--/--><button class="md:hidden flex flex-col justify-center items-center w-9 h-9 gap-1.5 rounded-lg hover:bg-green-700/60 dark:hover:bg-green-900/60 transition-colors" aria-label="Toggle menu"', '><span class="', '"></span><span class="', '"></span><span class="', '"></span></button></div></div><div class="', '"><ul class="flex flex-col gap-1"><!--$-->', "<!--/--><li>", "</li></ul></div></div></nav>"], _tmpl$3 = ["<li", ">", "</li>"], _tmpl$4 = ["<span", ' class="absolute -top-1 -right-1 flex items-center justify-center min-w-[1.1rem] h-[1.1rem] rounded-full bg-amber-400 text-slate-900 text-[10px] font-bold px-0.5">', "</span>"], _tmpl$5 = ["<span", ' class="ml-2 inline-flex items-center justify-center rounded-full bg-amber-400 text-slate-900 text-xs font-bold px-1.5 py-0.5">', "</span>"];
const NAV_LINKS = [{
  href: "/",
  labelKey: "nav.home"
}, {
...
function Nav() {
  ...
  const linkClass = (path) => `block px-3 py-2 rounded text-sm font-medium transition-colors ${isActive2(path) ? "bg-green-700 dark:bg-green-800 text-white" : "text-gray-100 hover:bg-green-700/60 dark:hover:bg-green-900/60"}`;
  ...
  return ssr(_tmpl$2, ssrHydrationKey(), escape(createComponent(A, {
    ...
    href: "/bookmarks",
    get ["class"]() {
      return `relative flex items-center justify-center w-9 h-9 rounded-lg transition-colors ${isActive2("/bookmarks") ? "bg-green-700 dark:bg-green-800 text-white" : "text-gray-100 hover:bg-green-700/60 dark:hover:bg-green-900/60"}`;
    },
    get ["aria-label"]() {
    ...
    href: "/bookmarks",
    get ["class"]() {
      return linkClass("/bookmarks");
    },
    onClick: () => setMenuOpen(false),
    get children() {
      return [t("nav.bookmarks"), bookmarkCount() > 0 && ssr(_tmpl$5, ssrHydrationKey(), escape(bookmarkCount()))];
    }
  })));
}
function App() {
...
//# sourceMappingURL=app-Dg6eK0D7.mjs.map
