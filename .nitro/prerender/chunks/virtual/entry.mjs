...
async function handleSingleFlight(sourceEvent, result) {
  ...
  return await provideRequestEvent(event, async () => {
    ...
    App || (App = (await import('../_/app-CtPYolTU.mjs')).default);
